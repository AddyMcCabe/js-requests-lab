...
*/
  ...
  sayHelloButton = document.getElementById('say-hello-button');
...
*/
 ...
 function changeHelloBtnColor() {
     sayHelloButton.style.backgroundColor = 'black';
     sayHelloButton.style.color = 'white';
    console.log(sayHelloBtnColor)
 }
...
*/
 ...
 function helloBtnResetColor() {
     sayHelloButton.style.backgroundColor = '#EFEFEF';
     sayHelloButton.style.color = 'black'
 }

 sayHelloButton.addEventListener('mouseout', helloBtnResetColor);
